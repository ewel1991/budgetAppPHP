          ...
          <div class=" p-5 pt-0">
            ...
            <form method="POST" id="registerForm">
              ...
              <div class="form-floating mb-3">
                <input value="<?php echo e($oldFormData['name'] ?? ''); ?>" type="text" name="name" class="form-control rounded-3" id="floatingText" placeholder="Ewelina" required minlength="3" maxlength="20" pattern="[A-Za-zĄąĆćĘęŁłŃńÓóŚśŹźŻż]{3,20}" title="Imię może zawierać tylko litery (bez cyfr i znaków specjalnych) od 3 do 20 znaków">
              ...
              <div class="form-floating mb-3">
                <input value="<?php echo e($oldFormData['email'] ?? ''); ?>" type="email" name="email" class="form-control rounded-3" id="floatingInput" placeholder="name@example.com">
              ...
              <div class="form-floating mb-3">
                <input type="password" name="password" class="form-control rounded-3" id="password1" placeholder="Password" required minlength="3" maxlength="20" pattern=".{3,20}" title="Hasło musi mieć od 3 do 20 znaków">
              ...
              <div class="form-floating mb-3">
                <input type="password" name="confirmPassword" class="form-control rounded-3" id="password2" placeholder="Password">
